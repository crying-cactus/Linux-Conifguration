...
hl.monitor({ output = "DP-3", mode = "2560x1440@240.08", position = "2560x0", scale = 1 })
hl.monitor({ output = "DP-4", mode = "2560x1440@240.08", position = "0x0",    scale = 1 })
...
-- DP-4 (left monitor): workspaces 1-5
...
local waybarReload      = "~/.config/waybar/scripts/launch.sh"
local sessionManager    = "rofi -show scripts"
local bluetooth         = "~/.config/bluetui/scripts/launch.sh"
local powermenu         = "~/.config/rofi/scripts/powermenu.sh"
local connectionmenu    = "~/.config/rofi/scripts/connectionmenu.sh"
...
-- hl.bind(mainMod .. " + C", hl.dsp.exec_cmd("~/.config/rofi/scripts/connectionmenu.sh"))
-- (workspace 9/10 move binds now handled by the 1-10 loop below)

-- Example special workspace (scratchpad)
hl.bind(mainMod .. " + S", hl.dsp.workspace.toggle_special("magic"))
hl.bind(mainMod .. " + SHIFT + S", hl.dsp.window.move({ workspace = "special:magic" }))

-- Workspace switching keybinds (workspace 10 is bound to the "0" key, standard convention)
for i = 1, 10 do
